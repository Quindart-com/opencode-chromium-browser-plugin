...
export const NETWORK_INSPECT_MANIFEST = Object.freeze({
  parameters: [
    ...
    { name: "bodyDelivery", type: "enum", values: ["inline", "artifact"], default: "inline", description: "Deliver requested bodies as inline previews or as artifact URIs that spill to the artifact store." },
    { name: "requestId", type: "string", description: "Restrict inspection to a single request ID from a prior network result." },
